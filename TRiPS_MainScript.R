...
dogenera = FALSE # is TRUE genus level analysis/plotting is performed.
doanalysis = TRUE # if true analysis is rerun. If False only figures from saved analysis is loaded and plotted
